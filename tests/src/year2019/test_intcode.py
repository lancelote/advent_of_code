...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("1002,4,3,4,33", {0: 1002, 1: 4, 2: 3, 3: 4, 4: 99}),
        ("1101,100,-1,4,0", {0: 1101, 1: 100, 2: -1, 3: 4, 4: 99}),
    ],
)
...
@pytest.mark.parametrize(
    "program,user_text,expected_dram",
    [
